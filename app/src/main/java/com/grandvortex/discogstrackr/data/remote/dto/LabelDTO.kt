...
data class LabelDTO(
    ...
    @Json(name = "parent_label") val parentLabel: ParentLabelDTO? = null,
    ...
    @Json(name = "sublabels") val sublabels: List<SublabelDTO>? = null,
